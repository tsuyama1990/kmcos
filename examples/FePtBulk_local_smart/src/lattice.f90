...
!******
integer(kind=iint), parameter, public :: fept = 0
integer(kind=iint), public :: default_layer = fept
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = fept
...
!******
integer(kind=iint), parameter, public :: fept_origin = 1
