...
subroutine run_proc_FePt_interaction_10(cell)
...
! Disable processes
    ...
    if(can_do(FePt_interaction_0,cell + (/ 1, 1, 2, 1/))) then
        call del_proc(FePt_interaction_0,cell + (/ 1, 1, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_1,cell + (/ 2, 0, 2, 1/))) then
        call del_proc(FePt_interaction_1,cell + (/ 2, 0, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_3,cell + (/ 1, 1, 0, 1/))) then
        call del_proc(FePt_interaction_3,cell + (/ 1, 1, 0, 1/))
    end if
    ...
    if(can_do(FePt_interaction_4,cell + (/ 0, 0, 2, 1/))) then
        call del_proc(FePt_interaction_4,cell + (/ 0, 0, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 1, -1, 2, 1/))) then
        call del_proc(FePt_interaction_6,cell + (/ 1, -1, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_7,cell + (/ 2, 0, 0, 1/))) then
        call del_proc(FePt_interaction_7,cell + (/ 2, 0, 0, 1/))
    end if
    ...
    if(can_do(FePt_interaction_9,cell + (/ 1, -1, 0, 1/))) then
        call del_proc(FePt_interaction_9,cell + (/ 1, -1, 0, 1/))
    end if
...
! Update rate constants
    ...
    if(can_do(FePt_interaction_0,cell + (/ 2, 1, 3, 1/))) then
        call update_rates_matrix(FePt_interaction_0,cell + (/ 2, 1, 3, 1/),gr_FePt_interaction_0(cell + (/ 2, 1, 3, 0/)))
    end if
    if(can_do(FePt_interaction_0,cell + (/ 3, 1, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_0,cell + (/ 3, 1, 2, 1/),gr_FePt_interaction_0(cell + (/ 3, 1, 2, 0/)))
    end if
    if(can_do(FePt_interaction_0,cell + (/ 1, 1, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_0,cell + (/ 1, 1, 4, 1/),gr_FePt_interaction_0(cell + (/ 1, 1, 4, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_1,cell + (/ 3, 0, 3, 1/))) then
        call update_rates_matrix(FePt_interaction_1,cell + (/ 3, 0, 3, 1/),gr_FePt_interaction_1(cell + (/ 3, 0, 3, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_1,cell + (/ 2, 0, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_1,cell + (/ 2, 0, 4, 1/),gr_FePt_interaction_1(cell + (/ 2, 0, 4, 0/)))
    end if
    if(can_do(FePt_interaction_1,cell + (/ -1, 1, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_1,cell + (/ -1, 1, 0, 1/),gr_FePt_interaction_1(cell + (/ -1, 1, 0, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_1,cell + (/ 4, 0, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_1,cell + (/ 4, 0, 2, 1/),gr_FePt_interaction_1(cell + (/ 4, 0, 2, 0/)))
    end if
    if(can_do(FePt_interaction_1,cell + (/ -1, -1, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_1,cell + (/ -1, -1, 0, 1/),gr_FePt_interaction_1(cell + (/ -1, -1, 0, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_4,cell + (/ 0, 0, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_4,cell + (/ 0, 0, 4, 1/),gr_FePt_interaction_4(cell + (/ 0, 0, 4, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 1, -1, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 1, -1, 4, 1/),gr_FePt_interaction_6(cell + (/ 1, -1, 4, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 2, -1, 3, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 2, -1, 3, 1/),gr_FePt_interaction_6(cell + (/ 2, -1, 3, 0/)))
    end if
    if(can_do(FePt_interaction_6,cell + (/ -1, 0, -1, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ -1, 0, -1, 1/),gr_FePt_interaction_6(cell + (/ -1, 0, -1, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 3, -1, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 3, -1, 2, 1/),gr_FePt_interaction_6(cell + (/ 3, -1, 2, 0/)))
    end if
    if(can_do(FePt_interaction_6,cell + (/ 1, 1, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 1, 1, 2, 1/),gr_FePt_interaction_6(cell + (/ 1, 1, 2, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_7,cell + (/ 4, 0, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_7,cell + (/ 4, 0, 0, 1/),gr_FePt_interaction_7(cell + (/ 4, 0, 0, 0/)))
    end if
    if(can_do(FePt_interaction_7,cell + (/ -1, 1, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_7,cell + (/ -1, 1, 0, 1/),gr_FePt_interaction_7(cell + (/ -1, 1, 0, 0/)))
    end if
...
end subroutine run_proc_FePt_interaction_10
