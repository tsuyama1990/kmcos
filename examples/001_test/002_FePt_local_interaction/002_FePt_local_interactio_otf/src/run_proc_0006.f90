...
subroutine run_proc_FePt_interaction_3(cell)
...
! Disable processes
    ...
    if(can_do(FePt_interaction_0,cell + (/ 0, 0, 2, 1/))) then
        call del_proc(FePt_interaction_0,cell + (/ 0, 0, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 0, -2, 2, 1/))) then
        call del_proc(FePt_interaction_6,cell + (/ 0, -2, 2, 1/))
    end if
    ...
    if(can_do(FePt_interaction_9,cell + (/ 0, -2, 0, 1/))) then
        call del_proc(FePt_interaction_9,cell + (/ 0, -2, 0, 1/))
    end if
...
! Update rate constants
    ...
    if(can_do(FePt_interaction_0,cell + (/ 0, 0, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_0,cell + (/ 0, 0, 4, 1/),gr_FePt_interaction_0(cell + (/ 0, 0, 4, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 0, -2, 4, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 0, -2, 4, 1/),gr_FePt_interaction_6(cell + (/ 0, -2, 4, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 0, -4, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 0, -4, 2, 1/),gr_FePt_interaction_6(cell + (/ 0, -4, 2, 0/)))
    end if
    if(can_do(FePt_interaction_6,cell + (/ -1, -1, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ -1, -1, 0, 1/),gr_FePt_interaction_6(cell + (/ -1, -1, 0, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_6,cell + (/ 0, -3, 3, 1/))) then
        call update_rates_matrix(FePt_interaction_6,cell + (/ 0, -3, 3, 1/),gr_FePt_interaction_6(cell + (/ 0, -3, 3, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_9,cell + (/ 0, -4, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_9,cell + (/ 0, -4, 0, 1/),gr_FePt_interaction_9(cell + (/ 0, -4, 0, 0/)))
    end if
    if(can_do(FePt_interaction_9,cell + (/ -1, -1, -2, 1/))) then
        call update_rates_matrix(FePt_interaction_9,cell + (/ -1, -1, -2, 1/),gr_FePt_interaction_9(cell + (/ -1, -1, -2, 0/)))
    end if
...
end subroutine run_proc_FePt_interaction_3
