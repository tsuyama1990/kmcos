...
subroutine run_proc_FePt_interaction_8(cell)
...
! Disable processes
    ...
    if(can_do(FePt_interaction_11,cell + (/ 0, -2, 0, 1/))) then
        call del_proc(FePt_interaction_11,cell + (/ 0, -2, 0, 1/))
    end if
    ...
    if(can_do(FePt_interaction_2,cell + (/ 2, 0, 0, 1/))) then
        call del_proc(FePt_interaction_2,cell + (/ 2, 0, 0, 1/))
    end if
    ...
    if(can_do(FePt_interaction_5,cell + (/ 2, -2, 0, 1/))) then
        call del_proc(FePt_interaction_5,cell + (/ 2, -2, 0, 1/))
    end if
...
! Update rate constants
    ...
    if(can_do(FePt_interaction_11,cell + (/ 0, -4, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_11,cell + (/ 0, -4, 0, 1/),gr_FePt_interaction_11(cell + (/ 0, -4, 0, 0/)))
    end if
    if(can_do(FePt_interaction_11,cell + (/ -1, -2, -1, 1/))) then
        call update_rates_matrix(FePt_interaction_11,cell + (/ -1, -2, -1, 1/),gr_FePt_interaction_11(cell + (/ -1, -2, -1, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_2,cell + (/ 4, 0, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_2,cell + (/ 4, 0, 0, 1/),gr_FePt_interaction_2(cell + (/ 4, 0, 0, 0/)))
    end if
    if(can_do(FePt_interaction_2,cell + (/ -1, 1, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_2,cell + (/ -1, 1, 0, 1/),gr_FePt_interaction_2(cell + (/ -1, 1, 0, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_5,cell + (/ 4, -2, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_5,cell + (/ 4, -2, 0, 1/),gr_FePt_interaction_5(cell + (/ 4, -2, 0, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_5,cell + (/ 2, -4, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_5,cell + (/ 2, -4, 0, 1/),gr_FePt_interaction_5(cell + (/ 2, -4, 0, 0/)))
    end if
    if(can_do(FePt_interaction_5,cell + (/ -1, 0, 1, 1/))) then
        call update_rates_matrix(FePt_interaction_5,cell + (/ -1, 0, 1, 1/),gr_FePt_interaction_5(cell + (/ -1, 0, 1, 0/)))
    end if
    ...
    if(can_do(FePt_interaction_5,cell + (/ 3, -3, 0, 1/))) then
        call update_rates_matrix(FePt_interaction_5,cell + (/ 3, -3, 0, 1/),gr_FePt_interaction_5(cell + (/ 3, -3, 0, 0/)))
    end if
    if(can_do(FePt_interaction_5,cell + (/ 1, -1, 2, 1/))) then
        call update_rates_matrix(FePt_interaction_5,cell + (/ 1, -1, 2, 1/),gr_FePt_interaction_5(cell + (/ 1, -1, 2, 0/)))
    end if
...
end subroutine run_proc_FePt_interaction_8
