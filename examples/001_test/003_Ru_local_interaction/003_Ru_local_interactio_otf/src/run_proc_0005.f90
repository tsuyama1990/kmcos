...
subroutine run_proc_ru_interaction_12(cell)
...
! Disable processes
    ...
    if(can_do(ru_interaction_13,cell + (/ 0, -1, 0, 1/))) then
        call del_proc(ru_interaction_13,cell + (/ 0, -1, 0, 1/))
    end if
    if(can_do(ru_interaction_14,cell + (/ -1, 0, 0, 1/))) then
        call del_proc(ru_interaction_14,cell + (/ -1, 0, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_15,cell + (/ -1, -2, 0, 1/))) then
        call del_proc(ru_interaction_15,cell + (/ -1, -2, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_16,cell + (/ -2, -1, 0, 1/))) then
        call del_proc(ru_interaction_16,cell + (/ -2, -1, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_17,cell + (/ -2, -2, 0, 1/))) then
        call del_proc(ru_interaction_17,cell + (/ -2, -2, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_6,cell + (/ 0, 0, 1, 1/))) then
        call del_proc(ru_interaction_6,cell + (/ 0, 0, 1, 1/))
    end if
    ...
    if(can_do(ru_interaction_8,cell + (/ -1, 0, 1, 1/))) then
        call del_proc(ru_interaction_8,cell + (/ -1, 0, 1, 1/))
    end if
    if(can_do(ru_interaction_9,cell + (/ -1, 0, 0, 1/))) then
        call del_proc(ru_interaction_9,cell + (/ -1, 0, 0, 1/))
    end if
...
! Update rate constants
    ...
    if(can_do(ru_interaction_15,cell + (/ -1, -3, 0, 1/))) then
        call update_rates_matrix(ru_interaction_15,cell + (/ -1, -3, 0, 1/),gr_ru_interaction_15(cell + (/ -1, -3, 0, 0/)))
    end if
    if(can_do(ru_interaction_15,cell + (/ -2, -3, 0, 1/))) then
        call update_rates_matrix(ru_interaction_15,cell + (/ -2, -3, 0, 1/),gr_ru_interaction_15(cell + (/ -2, -3, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_16,cell + (/ -3, -1, 0, 1/))) then
        call update_rates_matrix(ru_interaction_16,cell + (/ -3, -1, 0, 1/),gr_ru_interaction_16(cell + (/ -3, -1, 0, 0/)))
    end if
    if(can_do(ru_interaction_16,cell + (/ -3, -2, 0, 1/))) then
        call update_rates_matrix(ru_interaction_16,cell + (/ -3, -2, 0, 1/),gr_ru_interaction_16(cell + (/ -3, -2, 0, 0/)))
    end if
    if(can_do(ru_interaction_16,cell + (/ -1, -1, 0, 1/))) then
        call update_rates_matrix(ru_interaction_16,cell + (/ -1, -1, 0, 1/),gr_ru_interaction_16(cell + (/ -1, -1, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_17,cell + (/ -3, -3, 0, 1/))) then
        call update_rates_matrix(ru_interaction_17,cell + (/ -3, -3, 0, 1/),gr_ru_interaction_17(cell + (/ -3, -3, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_17,cell + (/ -2, -3, 0, 1/))) then
        call update_rates_matrix(ru_interaction_17,cell + (/ -2, -3, 0, 1/),gr_ru_interaction_17(cell + (/ -2, -3, 0, 0/)))
    end if
    if(can_do(ru_interaction_17,cell + (/ -3, -2, 0, 1/))) then
        call update_rates_matrix(ru_interaction_17,cell + (/ -3, -2, 0, 1/),gr_ru_interaction_17(cell + (/ -3, -2, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_8,cell + (/ -2, 0, 1, 1/))) then
        call update_rates_matrix(ru_interaction_8,cell + (/ -2, 0, 1, 1/),gr_ru_interaction_8(cell + (/ -2, 0, 1, 0/)))
    end if
    ...
    if(can_do(ru_interaction_9,cell + (/ -2, 0, 0, 1/))) then
        call update_rates_matrix(ru_interaction_9,cell + (/ -2, 0, 0, 1/),gr_ru_interaction_9(cell + (/ -2, 0, 0, 0/)))
    end if
    if(can_do(ru_interaction_9,cell + (/ -1, 1, 0, 1/))) then
        call update_rates_matrix(ru_interaction_9,cell + (/ -1, 1, 0, 1/),gr_ru_interaction_9(cell + (/ -1, 1, 0, 0/)))
    end if
...
end subroutine run_proc_ru_interaction_12
