...
subroutine run_proc_ru_interaction_4(cell)
...
! Disable processes
    ...
    if(can_do(ru_interaction_0,cell + (/ 2, 1, 0, 1/))) then
        call del_proc(ru_interaction_0,cell + (/ 2, 1, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_1,cell + (/ 2, 0, 0, 1/))) then
        call del_proc(ru_interaction_1,cell + (/ 2, 0, 0, 1/))
    end if
    ...
    if(can_do(ru_interaction_22,cell + (/ 0, -1, 0, 1/))) then
        call del_proc(ru_interaction_22,cell + (/ 0, -1, 0, 1/))
    end if
    if(can_do(ru_interaction_23,cell + (/ 0, -1, -1, 1/))) then
        call del_proc(ru_interaction_23,cell + (/ 0, -1, -1, 1/))
    end if
    ...
    if(can_do(ru_interaction_5,cell + (/ 0, -1, 0, 1/))) then
        call del_proc(ru_interaction_5,cell + (/ 0, -1, 0, 1/))
    end if
...
! Update rate constants
    ...
    if(can_do(ru_interaction_0,cell + (/ 3, 1, 0, 1/))) then
        call update_rates_matrix(ru_interaction_0,cell + (/ 3, 1, 0, 1/),gr_ru_interaction_0(cell + (/ 3, 1, 0, 0/)))
    end if
    if(can_do(ru_interaction_0,cell + (/ 0, -1, 0, 1/))) then
        call update_rates_matrix(ru_interaction_0,cell + (/ 0, -1, 0, 1/),gr_ru_interaction_0(cell + (/ 0, -1, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_1,cell + (/ 3, 0, 0, 1/))) then
        call update_rates_matrix(ru_interaction_1,cell + (/ 3, 0, 0, 1/),gr_ru_interaction_1(cell + (/ 3, 0, 0, 0/)))
    end if
    ...
    if(can_do(ru_interaction_12,cell + (/ 2, 0, -1, 1/))) then
        call update_rates_matrix(ru_interaction_12,cell + (/ 2, 0, -1, 1/),gr_ru_interaction_12(cell + (/ 2, 0, -1, 0/)))
    end if
    if(can_do(ru_interaction_12,cell + (/ 1, -1, -1, 1/))) then
        call update_rates_matrix(ru_interaction_12,cell + (/ 1, -1, -1, 1/),gr_ru_interaction_12(cell + (/ 1, -1, -1, 0/)))
    end if
    ...
    if(can_do(ru_interaction_7,cell + (/ 2, 0, -1, 1/))) then
        call update_rates_matrix(ru_interaction_7,cell + (/ 2, 0, -1, 1/),gr_ru_interaction_7(cell + (/ 2, 0, -1, 0/)))
    end if
...
end subroutine run_proc_ru_interaction_4
