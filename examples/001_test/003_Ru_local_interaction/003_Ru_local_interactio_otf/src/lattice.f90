...
!******
integer(kind=iint), parameter, public :: ru_slab_p1 = 1
integer(kind=iint), parameter, public :: ru_slab_p2 = 2
...
!******
    ...
    unit_cell_size(1, 1) = 2.69844
    unit_cell_size(1, 2) = 0.0
    unit_cell_size(1, 3) = 0.0
    unit_cell_size(2, 1) = -1.3492199999999994
    unit_cell_size(2, 2) = 2.336917590588081
    unit_cell_size(2, 3) = 0.0
    unit_cell_size(3, 1) = 0.0
    unit_cell_size(3, 2) = 0.0
    unit_cell_size(3, 3) = 4.27305
    site_positions(1,:) = (/0.0, 0.0, 0.0/)
    site_positions(2,:) = (/0.33333, 0.66666, 0.5/)
